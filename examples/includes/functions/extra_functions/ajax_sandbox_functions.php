...
function zen_get_random_product()
{
  ...
  if (!empty($retVal['products_image']) && file_exists(DIR_WS_IMAGES . $retVal['products_image']))
  {
    $retVal['products_image'] = DIR_WS_IMAGES . $retVal['products_image'];
  } else
  {
    $retVal['products_image'] = DIR_WS_IMAGES . 'no_picture.gif';
  }
